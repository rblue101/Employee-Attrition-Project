...
```{r}
pred_attrition <- predict(NB_Final, no_attrition)

no_attrition$PredictedAttrition = pred_attrition

write.csv(pred_attrition, "/Users/rober/OneDrive/Desktop/MSDS 6306/Employee-Attrition-Project/Case2PredictionsBlue_Attrition.csv")
...
```{r}
pred_income <- predict(lm1, no_salary)

no_salary$PredictedIncome = pred_income

write.csv(pred_income, "/Users/rober/OneDrive/Desktop/MSDS 6306/Employee-Attrition-Project/Case2PredictionsBlue_Income.csv")
```
